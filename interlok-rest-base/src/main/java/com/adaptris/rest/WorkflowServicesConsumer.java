...
public abstract class WorkflowServicesConsumer implements ComponentLifecycle, ComponentLifecycleExtension {
  ...
  /**
   * This is the url that this consumer will listen for requests. For example "/workflow-services/*"; will trigger this consumer for any
   * requests on "http://host:port/workflow-services/...".
   */
  @Getter
  @Setter
  ...
  protected abstract StandaloneConsumer configureConsumer(AdaptrisMessageListener messageListener, String consumedUrlPath,
  ...
  protected void doResponse(AdaptrisMessage orig, AdaptrisMessage proc, String contentType) throws ServiceException {
    doResponse(orig, proc, contentType, OK_200);
  }

  protected abstract void doResponse(AdaptrisMessage orig, AdaptrisMessage proc, String contentType, int httpResponse);
